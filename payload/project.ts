  ...
  list: [
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content: '초기 개발은 폴링 방식으로 구현하여, 유저가 채팅방을 생성하고 채팅을 입력하면 서버에서 해당 채팅을 LLM으로 전송하고 콜백을 받아 유저에게 답장을 보여주는 구조로 설계.'
        },
        {
          content: '1단계에서는 채팅 생성 시 상태를 "Q"로 저장하고, 1초 간격의 스케줄러가 상태가 "Q"인 데이터를 조회하여 LLM에 전송 후 상태를 "P"로 변경. 콜백이 오면 답장 내용을 업데이트하고 상태를 "S"로 변경하는 방식을 적용.'
        },
        {
