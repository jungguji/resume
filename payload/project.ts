  ...
  list: [
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
          "이렇게 대규모 트래픽을 안정적으로 처리하고 시스템 확장성을 확보했던 경험은, 프리윌린의 <strong style='font-weight: bold;'>`매쓰플랫`</strong> 서비스가 성장함에 따라 발생할 수 있는 기술적 과제를 해결하고 <strong style='font-weight: bold;'>확장 가능한 인프라 구축에 기여</strong>할 수 있을 것입니다."
        }
      ],
    },
    {
