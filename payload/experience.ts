  ...
  list: [
    {
      ...
      descriptions: [
        ...
        'AI 챗봇 결제/재화 시스템 개발: **신규 비즈니스 모델 안정성 확보**',
        'AI 기반 선톡 기능 개발: **사용자 리텐션 20%p 개선**',
        'AI 챗봇 시스템 개선: 채팅 응답 속도 **99% 개선** (5분이상 -> 3초 이내)',
        '프로모션 대량 트래픽 장애대응',
      ],
      skillKeywords: [
        'Java',
    ...
    },
    {
      ...
      descriptions: [
        ...
        '대규모 푸시 알림 시스템 최적화: 발송 시간 **90% 단축** (5시간→30분)',
        '백엔드 공통 JPA Entity 모듈화: 개발 생산성 향상 및 작업 공수 감소',
        'JSP 페이지 로딩 속도 개선: 핵심 페이지 사용자 경험(UX) 최적화',
