...
const experience: IExperience.Payload = {
  ...
  list: [
    ...
    },
    {
      ...
      endedAt: '2023-04',
      descriptions: [
        '`유일한 백엔드 개발자`로서, B2C(웨딩의 여신), B2B(입점 업체)부터 백오피스 시스템까지 전 영역의 개발/운영을 총괄하며 아키텍처 및 개발 프로세스 개선을 주도함.',
    ...
    },
    {
      ...
      endedAt: '2019-06',
      descriptions: [
        'LG전자, 한국항공우주산업, 두산인프라코어 등 대기업 고객사의 PLM/MES 시스템 구축 SI 프로젝트 참여',
        'Java, Spring, Oracle 등의 환경에서 고객사 비즈니스 프로세스에 맞춘 기능 개발 및 인터페이스(SOAP) 개발 주도',
